    ...
    <div>
        ...
        <image-modal :visible="isVideoDisplayed" transition="roll">
            <div class="modal-content">
                <youtube :video-id="videoID" player-height="720" player-width="1280" :player-vars="playerVars"></youtube>
            </div>
        </image-modal>
...
export default {
    ...
    computed: {
        getOriginURL: function() {
            if (process.env.NODE_ENV === 'production') return process.env.VUE_APP_YT_ORIGIN_URL;
