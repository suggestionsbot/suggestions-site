        ...
        <section class="section">
            <div class="container">
                ...
                <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the
                    <a href="https://suggestionsbot.com">https://suggestionsbot.com</a> website (the "Service") operated by Suggestion's Bot ("us", "we", or
                    "our").</p>
...
export default {
    ...
    metaInfo: function() {
        return {
            ...
            meta: [
                { name: 'description', content: 'View the Terms of Service for the Suggestion\'s bot.' }
            ]
        };
    },
    data: function() {
