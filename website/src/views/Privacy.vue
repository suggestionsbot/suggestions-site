        ...
        <section class="section">
            <div class="container">
                ...
                <p>This document entails the privacy policy and agreement that you accept when adding the <strong>Suggestions</strong>#2602
                    ...
                    <a href="https://suggestionsbot.com">suggestionsbot.com</a> and all of its subdomains. This document does not supersede the
...
export default {
    ...
    metaInfo: function() {
        return {
            title: 'Privacy',
            meta: [
                { name: 'description', content: 'View the Privacy Policy for the Suggestion\'s bot.' }
            ]
        }
    },
    data: function() {
